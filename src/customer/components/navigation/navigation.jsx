  ...
  return (
    <div className="bg-white">
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 overflow-hidden z-50 lg:hidden" onClose={setOpen}>
          <Transition.Child
            as={Fragment}
                ...
                <Tab.Panels as={Fragment}>
                  {navigation.categories.map((category) => (
                    <Tab.Panel key={category.name} className="px-4 pt-10 pb-8 space-y-10">
                      <div className="grid grid-cols-2 gap-x-4 flex">
                    ...
                    <Popover key={category.name} className="flex">
                      {({ open }) => (
                        <>
                          ...
                          >
                            <Popover.Panel className="absolute z-50 mt-12 w-screen max-w-xs lg:max-w-md">
                              <div className="bg-white shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden w-48rem">
                                <div className="px-4 py-6 flex">
                                  ...
                                  {category.sections.map((section) => (
                                    <div key={section.name}>
                                      <p id={`${category.id}-${section.id}-heading`} className="font-medium text-gray-900">
                                        {section.name}
                                      </p>
                                      <ul
                                        role="list"
